...
namespace Glitch_Bot
{
    public class Bot
    {
        ...
        private YTEngine _YouTubeEngine = new YTEngine();
        ...
        private async Task MessageSendHandler(DiscordClient sender, MessageCreateEventArgs e)
        {
        ...
        private async Task ButtonPressResponse(DiscordClient sender, ComponentInteractionCreateEventArgs e)
        {
            ...
            else if (e.Interaction.Data.CustomId == "modButton")
            {
                ...
                await e.Interaction.CreateResponseAsync(InteractionResponseType.UpdateMessage, new DiscordInteractionResponseBuilder().AddEmbed(new DiscordEmbedBuilder() { Title = "Moderation Commands",
                                                                                                                                                                            Description = CommandsList
                                                                                                                                                                            }));
            }    
        }
        ...
        private async Task StartVideoUploadNotifier(DiscordClient client, ulong channelIdToNotify)
        {
